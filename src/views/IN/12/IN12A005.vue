<template>
  <div class="section">
    <div class="in_chart_item mg_t40">
      <div class="tit">
        <div class="name"><strong class="line">안전형</strong></div>
        <div class="fz_16">예/적금 수준의 수익률을 기대하며, 투자원금에 손실이 발생하는 것을 원하지 않는 성향입니다.</div>
      </div>
      <div class="summary">따라서, 당사 금융투자상품별 위험도 분류 기준상 초저위험에 해당하는 상품을 권해드립니다.</div>
