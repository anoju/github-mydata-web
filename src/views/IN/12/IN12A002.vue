<template>
  <div class="section pd_b60">
    <div class="in_chart_item mg_t40">
      <div class="tit">
        <div class="name"><strong class="line">적극투자형</strong></div>
        <div class="fz_16">투자원금의 본전보다는 위험을 감내하더라도 높은 수준의 투자수익 실현을 추구하는 성향입니다.</div>
      </div>
      <div class="summary">따라서, 당사 금융투자상품별 위험도 분류 기준상 고위험에 해당하는 상품을 권해드립니다.</div>
          ...
          <kb-folding :active.sync="openAll">
            ...
            <div class="accordion_box">
              <div class="accordion_box_in">
                <ul class="txt_list">
                  <li class="dot">
                    <kb-button not>마이다스신성장기업포커스증권투자신탁주식블라 마이다스신성장기업포커스증권투자신탁주식블라</kb-button>
                  </li>
                  <li class="dot">
                    <kb-button not>마이다스신성장기업포커스증권투자신탁주식블라 마이다스신성장기업포커스증권투자신탁주식블라</kb-button>
                  </li>
          ...
          <kb-folding :active.sync="openAll">
            <template slot="title">
              <div class="chart_head">
                ...
                <div>
                  <strong class="type">상품&amp;특별자산</strong>
                  <strong class="cut">10</strong>
                </div>
                <div class="pre">67%</div>
              </div>
          ...
          <kb-folding :active.sync="openAll">
            <template slot="title">
              <div class="chart_head">
                ...
                <div>
                  <strong class="type">파생결합상품</strong>
                  <strong class="cut">10</strong>
                </div>
                <div class="pre">67%</div>
              </div>
