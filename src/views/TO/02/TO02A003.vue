<template>
  <kb-page page-title="총 자산 변동 추이">
    <kb-page-body>
      <div class="section">
        <div class="assets_change_info">
          <kb-select
            v-model="selectVal1"
            :options="selectOpt1"
            class="type_line"
          />
          <p class="tit">총 자산 변동 추이는?</p>
          <p class="date">조회기간 : 2010/2/01 - 2021/1/31</p>
          <ul class="assets_list_box">
            <li>
              <span>총 자산</span>
            ...
            <li>
              <span>자산 증감액</span>
              <span><b class="fc_down">-12.25%</b>100,000원</span>
            </li>
            <li>
              <span>현금 잔고</span>
              <span><b class="fc_up">+12.25%</b>12,000,000원</span>
            </li>
            <li>
              <span>투자 수익금</span>
              <span><b class="fc_up">+12.25%</b>240,000,000원</span>
            </li>
          </ul>
        </div>

        <!-- chart -->
        <div class="chart_area mg_b30"><img src="@/assets/images/TO/02/chart_total_assets.png" style="width:100%;" alt="총 자산 변동 추이 차트 이미지"></div>
        <!-- //chart -->
        ...
        <kb-table-scroll>
          ...
          >
            <thead>
              ...
              <tr>
                <th scope="col" colspan="3">월 증감 총액 / 순 자산</th>
              </tr>
            </thead>
            <tbody>
              <tr>
