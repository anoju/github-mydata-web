<template>
  <kb-pop full title="상세 주문 내역">
    <kb-pop-body>
      <div class="section">
        <div class="transactional_info_detail">
          <!-- 2021-05-02 링크로 변경 -->
          <kb-button not aTag class="tit">
            <span>005930</span>
            삼성전자 <i aria-hidden="true" class="bt_ic_arr"></i>
          </kb-button>
          <!-- //2021-05-02 링크로 변경 -->

          <p class="one_money">
            <!-- 2021-05-02 문구삭제 -->
            <span class="sub_tit">1주 가격</span>
            100,000원
            ...
            구매실패 : fail
            -->
            <span class="status success">구매완료</span>
        ...
        >
          <kb-folding title="적립식 거래">
            <ul class="txt_list pd_b90">
              ...
              <li class="dot">거래가능 시간은 평일 07:00~23:00입니다. (토/공휴일 제외)</li>
            </ul>
          </kb-folding>
        </kb-foldings>
      </div>
